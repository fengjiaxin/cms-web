...
import org.feng.cms.dto.UserDto;
import org.feng.cms.model.User;
import org.feng.cms.service.IGroupService;
import org.feng.cms.service.IRoleService;
...
public class UserController {
	...
	public String update(@PathVariable int id,Model model){
		...
		model.addAttribute("userDto", new UserDto(u,userService.listUserRoleIds(id),
	...
	public String show (@PathVariable int id,Model model){
		...
		model.addAttribute("gs", userService.listUserGroupIds(id));
